...
export default function TrustedBy() {
  return (
    <section id="trusted-by" className="py-8 md:py-10 bg-black overflow-hidden" aria-labelledby="trusted-by-heading">
      <h2 id="trusted-by-heading" className="text-center text-[11px] font-medium tracking-[0.2em] text-white/30 uppercase mb-6 sr-only">
        Trusted by
      </h2>
      <p className="text-center text-[11px] font-medium tracking-[0.2em] text-white/30 uppercase mb-6" aria-hidden="true">
        Trusted by
      </p>
      ...
      >
        <div className="flex items-center ticker-track animate-[ticker_80s_linear_infinite] motion-reduce:animate-none w-max">
          {items.map((logo, i) => (
            ...
            <div key={i} className="shrink-0 flex items-center pr-16">
